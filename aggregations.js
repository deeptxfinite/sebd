(function () {
  ...
  const search = function search(index, body) {
    console.log('----------------Before esClient.search method is called----------------');
    return esClient.search({index: index, body: body});
    console.log('----------------After esClient.search method is called----------------');
  };
  ...
  const test = function test() {
    ...
    console.log('----------------Before search method is called----------------');
    search('library', body)
    .then(results => {
    ...
    .catch(console.error);
    console.log('----------------After search method is called----------------');
  };

  console.log('----------------Before test method is called----------------');
  test();
  console.log('----------------After test method is called----------------');
